...
describe('etsy.draftListings', function() {
    before(function() {
        etsy = new Etsy();
    });
    ...
    describe('#get()', function() {
        context('when using default options', function() {
            ...
            it('should create output/draft-listings.csv', function(done) {
                this.timeout(5000);
        ...
        context('when using pagination options', function() {
            it('should get two pages and concat them', function(done) {
                ...
                etsy.draftListings.get(options).then((data) => {
                    ...
                    return etsy.draftListings.get(options);
                }).then((data) => {
                    rows = rows.concat(data.results);
